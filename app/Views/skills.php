      ...
      <div class="column">
        <div class="is-flex is-align-items-center mb-2">
          ...
          <button class="button is-small is-link is-rounded" id="toggle-technical-btn" onclick="toggleAddSkillInput('technical')">
            <span id="icon-technical" style="font-size: 1.5em; line-height: 1;">+</span>
          </button>
        </div>
        ...
        <ul id="technical-skills-list" class="mb-6 pl-5"></ul>
      </div>
      <div class="column">
        <div class="is-flex is-align-items-center mb-2">
          ...
          <button class="button is-small is-link is-rounded" id="toggle-programming-btn" onclick="toggleAddSkillInput('programming')">
            <span id="icon-programming" style="font-size: 1.5em; line-height: 1;">+</span>
          </button>
        </div>
        ...
        <ul id="programming-skills-list" class="mb-6 pl-5"></ul>
      </div>
    </div>
  </div>
</div>